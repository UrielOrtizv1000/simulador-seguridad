...
var QUESTION_BANK = [
  ...
  {id:'q4', topic:'cia', type:'mc',
    ...
    options:['Confidencialidad','Disponibilidad','Integridad','Autenticación'], answerIndex:1,
  ...
  {id:'q10', topic:'avr', type:'mc',
    ...
    options:['Un grupo de ciberdelincuentes','Un incendio en el centro de datos','Un ransomware','Contraseñas predeterminadas que nunca se cambiaron'], answerIndex:3,
  ...
  {id:'q14', topic:'ia', type:'fill',
    prompt:'El ataque en el que se ocultan instrucciones maliciosas en contenido externo (una web, un correo, un PDF) que un agente de IA procesa como si fueran legítimas se llama, en inglés, ____ (tres palabras).',
    answers:['indirect prompt injection'],
    explain:"Es la 'indirect prompt injection': el ataque no llega directo al chatbot, sino escondido en contenido que la IA lee y ejecuta."},
  ...
  {id:'q20', topic:'hackers', type:'fill',
    prompt:'Un ___ hat hacker entra sin permiso para buscar vulnerabilidades, pero las reporta en vez de causar daño.',
    answers:['grey','gray'],
    explain:'El grey hat (o gray hat) actúa sin autorización previa, pero reporta lo que encuentra en lugar de explotarlo.'},
  ...
  {id:'q23', topic:'hackers', type:'mc',
    ...
    options:['FraudGPT','DarkSide','Guacamaya','WannaCry'], answerIndex:3,
  ...
  {id:'q28', topic:'leyes', type:'mc',
    ...
    options:['La difusión de imágenes, videos o audios íntimos sin consentimiento','La piratería de software','La evasión de impuestos digitales','El envío de correo no deseado (spam)'], answerIndex:0,
  ...
  {id:'q36', topic:'eh', type:'mc',
    ...
    options:['Pedir permiso antes de atacar','No causar daño a sistemas ni datos','Trabajar siempre dentro de los límites legales','Explotar las vulnerabilidades encontradas sin reportarlas'], answerIndex:3,
  ...
  {id:'q37', topic:'eh', type:'mc',
    ...
    options:['CISSP','OSCP','CompTIA Security+','GPEN'], answerIndex:2,
  ...
  {id:'q38', topic:'eh', type:'mc',
    ...
    options:['Suplantación de identidad con fines de fraude','Difusión de contenido íntimo sin consentimiento','Evaluación de vulnerabilidades','Envenenamiento de datos de un modelo sin autorización'], answerIndex:2,
