...
var QUESTION_BANK = [
  ...
  {id:'q20', topic:'hackers', type:'fill',
    prompt:'Al hacker que entra sin permiso para buscar vulnerabilidades, pero las reporta en vez de causar daño, se le llama, en inglés, ___ (dos palabras).',
    answers:['grey hat','gray hat'],
